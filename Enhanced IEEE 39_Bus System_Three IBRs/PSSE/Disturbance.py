...
local_dir = os.getcwd()
rawFilePath = local_dir + '\\' + 'IEEE39_PV_30_BV_Pmax_Pmin_equals_Pgen.raw'
dyrFilePath = local_dir + '\\' + 'IEEE39bus_original_Modified5_30_BV_test_wecc_Tgov1'
...
psspy.branch_p_and_q_channel([-1,-1,-1,30,2], '1', "")
